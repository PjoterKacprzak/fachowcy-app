...
class _EditServiceCardState extends State<EditServiceCard> {
  ...
  List<String> _localization = ['Lodz', 'Warszawa', 'Poznan', 'Lodz-Centrum', 'Zgierz'];
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ServiceCard>(
      ...
      builder: (BuildContext context, AsyncSnapshot<ServiceCard> snapshot) {  // AsyncSnapshot<Your object type>
                                    ...
                                    children: <Widget>[
                                      ...
                                      FlatButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (await (updatePost(_serviceCardId,
                                              _title,
                                              _currentCategory,
                                              _image,
                                              _image2,
  ...
  Future<int> updatePost(int id,String title, String category, File photo, File photo2, File photo3, File photo4, int serviceType,
      String description, String location, String estimatedTime,String price,String exchangeDescription) async {
  ...
  Future<ServiceCard> getServiceCardFromId(int serviceCardId)
  async {
    ...
    // setState(() {
    //   _tempServiceCard = ServiceCard.fromJson(jsonDecode(responseSecond.body));
    // });
